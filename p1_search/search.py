...
def uniformCostSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    def cost(aPath): return problem.getCostOfActions([x[1] for x in aPath])
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    "*** YOUR CODE HERE ***"
    def cost(aPath): return problem.getCostOfActions(
        [x[1] for x in aPath]) + heuristic(aPath[len(aPath)-1][0], problem)
    frontier = util.PriorityQueueWithFunction(cost)
    return graphSearch(problem, frontier)
